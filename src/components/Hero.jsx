            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-32">
                <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
                    ...
                    <div className="w-full lg:w-1/2 text-center lg:text-left">
                        {/* Subtitle */}
                        <p className="text-accent-amber font-medium tracking-[0.2em] lg:tracking-[0.3em] uppercase text-[10px] lg:text-sm mb-4 lg:mb-6 animate-fade-in text-center lg:text-left w-full">
                        ...
                        {/* Description */}
                        <p className="max-w-xl mx-auto lg:mx-0 text-base lg:text-lg text-cocoa-light leading-relaxed mb-8 lg:mb-10 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
