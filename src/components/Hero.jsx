...
const HeroImage = ({ className = '' }) => (
    <div className={`relative animate-fade-in-up ${className}`} style={{ animationDelay: '0.2s' }}>
        <div className="hero-img-container relative sm:max-w-sm lg:max-w-[440px] xl:max-w-md mx-auto aspect-[4/5]">
            ...
            <img
                ...
                loading="eager"
                decoding="async"
                sizes="(max-width: 640px) 280px, (max-width: 1024px) 384px, 440px"
